...
import com.lab.ftp.config.SFTPConfigModel;
...
public class SFTPUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        sftp.login();
        if (!sftp.isExist("/order")) {
            sftp.createDirectory("/order");
        }
        File file = new File("E:\\test.png");
        InputStream is = new FileInputStream(file);
//        sftp.delete(sftpConfigModel.getUploadUrl(), "test.png");
...
/*        // 设置文件列表.
        ...
        fileBytesMap.put("test.png",IOUtils.toByteArray(is));
...
//        FileUtils.writeByteArrayToFile(new File("C:/Users/Administrator/Downloads/个人文件/2020-07-13/ram.zip"), memoryBytes);
        InputStreamSource inputStreamSource = new ByteArrayResource(memoryBytes);
        sftp.upload("/order/", "test.rar",  inputStreamSource.getInputStream());
        sftp.logout();
    }
