...
public class FTPUtil2 {
    ...
    public static void main(String[] args) {
        try {
            FileInputStream in = new FileInputStream(new File("C:\\Users\\lzqing\\Desktop\\Desk.rar"));
            boolean flag = uploadFile("10.123.225.171", 21, "plmftpuser", "12345!a", "", "/2017/11/19", "Desk3333.rar", in);
