...
/**
 * @Author: lzqing
 * @Description: JWT工具类，包含生成jwt 验证jwt
...
public class JwtUtil {
    ...
    public static String generateToken() throws JoseException, MalformedClaimException {
        ...
        List<String> groups = (List<String>) CollectionUtils.arrayToList(new String[]{"group-one", "other-group", "group-three"});
